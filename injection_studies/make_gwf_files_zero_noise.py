...
for interferometer in interferometers:
    ...
    np.savetxt(f'/home/shunyin.cheung/amp_memory_GWTC3/injection_studies/GW150914_A1_injection_zero_noise/{det}_psd.dat', psd_array)
    
    timeseries.write(f'/home/shunyin.cheung/amp_memory_GWTC3/injection_studies/GW150914_A1_injection_zero_noise/GW150914_mem_A1_{det}.txt')

    timeseries.plot()
    plt.savefig('GW150914_A1_injection_zero_noise/check_timeseries.png')
